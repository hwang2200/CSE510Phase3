...
public class DeleteQueryProgram {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(
                "Please enter in a query in the format: COLUMNDBNAME COLUMNARFILENAME [TARGETCOLUMNNAMES] VALUECONSTRAINT NUMBUF ACCESSTYPE");
        ...
        System.out.println("Please enter if the matching tuples should be deleted or not (\"YES\", \"NO\"");
        String deleteTuples = scanner.nextLine();

        String[] queryArgs = { colDBName, colFileName, valConstraint, nBuf, accessType, deleteTuples };
    ...
    private static void performFileScan(String[] args, String[] targetColNames) {
        if (args.length < 6 || targetColNames.length < 1) {
            System.err.println(
                    "Usage: COLUMNDBNAME COLUMNARFILENAME [TARGETCOLUMNNAMES] VALUECONSTRAINT NUMBUF ACCESSTYPE DELETE");
            System.exit(1);
        }
        ...
        try {
            ...
            switch (accessType.toUpperCase()) {
                case "FILESCAN":
                    performFileScan(columnarFileName, targetColNames, valueConstraint, del);
                    break;
                case "COLUMNSCAN":
                    performColumnScan(columnarFileName, targetColNames, valueConstraint, del);
                    break;
                case "BTREE":
                    performBTreeScan(columnarFileName, targetColNames, valueConstraint, del);
                    break;
                case "BITMAP":
                    performBitmapScan(columnarFileName, targetColNames, valueConstraint, del);
                    break;
                default:
    ...
    private static void performFileScan(String columnarFileName, String[] targetColumnNames, String valueConstraint, boolean delete) {
        try {
    ...
    private static void performColumnScan(String columnarFileName, String[] targetColumnNames, String valueConstraint, boolean delete)
        ...
        // Assuming you have a method to retrieve attribute types and sizes for the
        // specified column names
        // You need to implement this method based on your catalog or metadata
        // management
    ...
    private static void performBTreeScan(String columnarFileName, String[] targetColumnNames, String valueConstraint, boolean delete) {
        try {
    ...
    private static void performBitmapScan(String columnarFileName, String[] targetColumnNames, String valueConstraint, boolean delete) {
        try {
            String[] columnNames = new String[targetColumnNames.length];
            AttrType[] columnTypes = new AttrType[targetColumnNames.length];
